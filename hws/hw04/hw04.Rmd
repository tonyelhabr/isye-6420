...
+ target density function
  + a.k.a. posterior distribution (ideally, although may only be proportional or not actually known). *Here, it is not actually known.*
  + i.e. prior \times likelihood. *Use this if the posterior is not actually known.*
  + $\pi$ function.
